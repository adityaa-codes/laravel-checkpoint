...
|--------------------------------------------------------------------------
| DB_OPS_DRIVER           → Driver selection (auto-detected if omitted)
| DB_OPS_QUEUE_CONNECTION → Queue connection for async job dispatch
| DB_OPS_RESTORE_ALLOWED_ENVIRONMENTS → Environments where restore may run
| DB_OPS_RESTORE_REQUIRE_CONFIRMATION → Require interactive restore confirmation
| DB_OPS_NOTIFICATIONS_ENABLED         → Turn on failure/success notifications
|
...
return [
    'operations_enabled' => env('DB_OPS_OPERATIONS_ENABLED', true),
    ...
    'restore' => [
        ...
        'blast_radius' => [
            ...
            'block_score' => (int) env('DB_OPS_RESTORE_BLAST_RADIUS_BLOCK_SCORE', 60),
            'weights' => [
                'environment' => (int) env('DB_OPS_RESTORE_BLAST_RADIUS_WEIGHT_ENVIRONMENT', 40),
    ...
    'drivers' => [
        ...
        'pgdump' => [
            ...
            'drill_command' => env('DB_OPS_PGDUMP_DRILL_COMMAND', ''),
